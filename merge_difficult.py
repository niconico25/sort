def merge_sort_difficult(lst):
    ...
    _merge_sort_difficult(lst, tmp_lst, begin, end)


def _merge_sort_difficult(lst, tmp_lst, begin, end):
    if begin == end:
        return
    ...
    _merge_sort_difficult(lst, tmp_lst, begin, mid)
    _merge_sort_difficult(lst, tmp_lst, mid + 1, end)
